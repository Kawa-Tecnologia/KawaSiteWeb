            ...
            <div className='cadastro-container'>
                <form onSubmit={handleSubmit}>
                    ...
                    <div>
                        ...
                        <input type='text' id='document_number' name='document_number' value={formData.document_number} onChange={handleInputChange} required />
                    </div>

                    <div>
                        <h3>Endereço</h3>
                        <label htmlFor='cep'>CEP:</label>
                        <input type='text' id='cep' name='cep' value={formData.cep} onChange={handleInputChange} required />
                    </div>
                    <div>
