...
const DevCard: React.FC<Dev> = ({ imageSrc, name, role }) => {
  return (
...
const App: React.FC = () => {
  ...
  const developers: Dev[] = [
    ...
    // Adicione os demais desenvolvedores aqui
  ]
                ...
                <div className="dev-cards-container">
                  ...
                  {developers.map((dev, index) => (
                    <DevCard
                      key={index}
                      imageSrc={require(
                        `./assets/images/0-minimalist-gift-voucher___media_library_original_1600_914.jpg`,
                      )}
                      name={dev.name}
                      role={dev.role}
                    />
